...
// Represents the test web app that uses the AppAuthJS library.
        ...
        var JsAppAuth = /** @class */ (function () {
            ...
            JsAppAuth.prototype.makeAuthorizationRequest = function (appAuthConfiguration, clientId, redirectUri, scopes) {
                var configuration = new authorization_service_configuration_1.AuthorizationServiceConfiguration({
                    authorization_endpoint: appAuthConfiguration.authorization_endpoint,
                    end_session_endpoint: appAuthConfiguration.end_session_endpoint,
                    revocation_endpoint: appAuthConfiguration.revocation_endpoint,
                    token_endpoint: appAuthConfiguration.token_endpoint,
                    userinfo_endpoint: appAuthConfiguration.userinfo_endpoint
                });
                ...
                if (configuration) {
                    ...
                    console.log('Fetch Authorization Service configuration, before you make the authorization request.');
                }
            };
            JsAppAuth.prototype.checkForAuthorizationResponse = function () {
                this.authorizationHandler.completeAuthorizationRequestIfPossible();
            };
            return JsAppAuth;
        }());
        exports.JsAppAuth = JsAppAuth;
// export App
        window['JsAppAuth'] = JsAppAuth;

    },{"../authorization_request":2,"../authorization_request_handler":3,"../authorization_service_configuration":5,"../logger":9,"../redirect_based_handler":11,"../token_request_handler":13}],2:[function(require,module,exports){
        "use strict";
        /*
         * Copyright 2017 Google Inc.
         *
...
// TODO(rahulrav@): add more built in parameters.
    ...
    },{"./xhr":15}],6:[function(require,module,exports){
        "use strict";
        /*
         * Copyright 2017 Google Inc.
         *
...
// well supported: https://caniuse.com/#search=TextEncoder
    ...
    },{"./errors":7,"base64-js":16}],7:[function(require,module,exports){
        "use strict";
        /*
         * Copyright 2017 Google Inc.
         *
...
// check to see if native support for profiling is available.
    ...
    },{"./errors":7,"./query_string_utils":10,"./token_response":14,"./xhr":15}],14:[function(require,module,exports){
        "use strict";
        /*
         * Copyright 2017 Google Inc.
         *
